                            ...
                            <ul class="menu">
                                ...
                                <li>
                                    <a href="#"> <i class="fa fa-warning text-yellow"></i>
                                        Very long description here that may not fit into the page and may
                            ...
                            <ul class="menu">
                                <li>
                                    <a href="#">
                                        ...
                                        <div class="progress xs">
                                            <div class="progress-bar progress-bar-aqua wp-20"
                                ...
                                <li>
                                    <a href="#">
                                        ...
                                        <div class="progress xs">
                                            <div class="progress-bar progress-bar-green wp-40"
                                                 role="progressbar" aria-valuenow="20"
                                                 aria-valuemin="0" aria-valuemax="100">
                                ...
                                <li>
                                    <a href="#">
                                        ...
                                        <div class="progress xs">
                                            <div class="progress-bar progress-bar-red wp-60"
                                ...
                                <li>
                                    <a href="#">
                                        ...
                                        <div class="progress xs">
                                            <div class="progress-bar progress-bar-yellow wp-80"
                                                 role="progressbar" aria-valuenow="20"
                                                 aria-valuemin="0" aria-valuemax="100">
